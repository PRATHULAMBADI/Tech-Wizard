      ...
      <Router>
        <Routes>
          ...
          <Route
            ...
            element={<UserPasswordResetRequestForm />}
          />
          <Route
            path="/user-resetPassword/:resetToken/:email"
            element={<UserPasswordResetForm />}
          />
          ...
          <Route
            path="/organizer-resetPasswordRequest"
            element={<OrganizerPasswordResetRequestForm />}
          />
          <Route
            path="/organizer-resetPassword/:resetToken/:email"
            element={<OrganizerPasswordResetForm />}
          />
