  ...
  return (
    <BackgroundContainer>
      <WelcomePageHeading/>
        ...
        <ButtonContainer>
          <WelcomePageButton type="submit" title="Login as User" onClick={handleLogInAsUser}>User</WelcomePageButton>
          ...
          <WelcomePageButton type="submit" title="Login as Organizer" onClick={handleLogInAsOrganizer}>Organizer</WelcomePageButton>
        </ButtonContainer>
      </BackgroundContainer>
  );
};
