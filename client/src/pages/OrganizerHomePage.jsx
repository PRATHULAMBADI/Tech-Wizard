...
const OrganizerHomePage = () => {
  ...
  const filteredPrograms = programs.filter(
    (program) =>
      ...
      (program.programType &&
        program.programType.toLowerCase().includes(searchQuery.toLowerCase())) // Check if programType is defined before accessing it
  );
      ...
      <Container>
        ...
        <IconsContainer>
          ...
          <IconsHolder>
            ...
            >
              <AddIcon title="Add New Program" />
              <IconLabel>Add New Program</IconLabel>
            </IconsHolderUserRegiteredPrograms>
          </IconsHolder>
          <IconsHolder>
            <IconsHolderStyledLogoutIcon onClick={handleLogout}>
              <StyledLogoutIcon title="Log Out" />
              <IconLabel>Log Out</IconLabel>{" "}
            </IconsHolderStyledLogoutIcon>
          </IconsHolder>
        </IconsContainer>
        <div>
              ...
              {filteredPrograms.map((program) => (
                <Tile key={program._id}>
                  ...
                  <TileContent>
                    ...
                    <TileDetails>
                      <TileLabel> Conducted by:</TileLabel>{" "}
                      <Details>{program.conductingPerson}</Details>
                    </TileDetails>
                    <TileDetails>
                      <TileLabel>Program:</TileLabel>{" "}
                      <Details>{program.programType}</Details>
                    </TileDetails>
                    <TileDetails>
                      <TileLabel>Date:</TileLabel>{" "}
                      <Details> {handleDate(program.dateTime)}</Details>
                    </TileDetails>
                    <TileDetails>
                      <TileLabel>Time:</TileLabel>{" "}
                      <Details> {handleTime(program.dateTime)} </Details>
                    </TileDetails>
                    <TileDetails>
                      <TileLabel>Duration:</TileLabel>{" "}
                      <Details> {program.duration} </Details>
                    ...
                    <ButtonContainer>
                      <Button
                        onClick={() => handleEditProgramClick(program._id)}
                      >
                        Edit Details
                      </Button>
                      <Button onClick={() => handleDeleteProgram(program._id)}>
                        Delete
                      </Button>
                    </ButtonContainer>
                  </TileContent>
